 ...
 * [Level1Fragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Level1Fragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class Level1Fragment : NavHostFragment() {
...
try {
    findNavController().navigate(Level1FragmentDirections.actionLevel1FragmentToJump())
}catch (e:Exception){
    e.printStackTrace()
}
}
